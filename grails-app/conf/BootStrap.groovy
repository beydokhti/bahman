...
//                            ,document: ${resource(dir:'images',file:'settelmentCer.png')}).save()
        ...
        def phase4=new Phase(phase: "BuyerBroker",comment: "test1", organization: usr1, startDate:new Date('1391/09/22'),endDate:new Date('1391/09/22'),status:"Pass" ).save()
        def phase5=new Phase(phase: "DealerBroker",comment: "test2", organization: usr6, startDate:new Date('1391/09/22'),endDate:new Date('1391/09/22'),status:"Pass" ).save()
        def phase6=new Phase(phase: "Supplier",comment: "test2", organization: usr6, startDate:new Date('1391/09/22'),status:"Waiting" ).save()
