...
//            def tolid =  Manufacturer.findByUsername("tolidi")?:new Manufacturer(code: "567", description:"پالایشگاه تبریز", username: "tolidi", password: "test", enabled: true).save()
//            def userRole14 = UserRole.findByUser(tolid)?:UserRole.create(tolid, mRole)
//            def bazargani = Supplier.findByUsername("bazargani")?:new Supplier(code: "567", description: "پالایشگاه تبریز", username: "bazargani", password: "test", enabled: true).save()
